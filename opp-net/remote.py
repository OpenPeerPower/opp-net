...
class RemoteUI:
    ...
    async def load_backend(self) -> bool:
        ...
        try:
            ...
            msg = "Can't update remote details from Open Peer Power cloud"
        ...
        if self.cloud.client.aiohttp_runner is None:
            ...
            # aiohttp_runner comes available when Open Peer Power has started.
    ...
    async def connect(self) -> None:
        ...
        try:
            ...
            self.cloud.client.user_message(
                ...
                "Remote connection is disabled because this Open Peer Power instance is marked as insecure. For more information and to enable it again, visit the [Nabu Casa Account page](https://account.openpeerpower.com).",
            )
            insecure = True
        except SubscriptionExpired:
            pass
        except AttributeError:
            pass  # Ignore because OP shutdown on snitun token refresh
        finally:
            # start retry task
